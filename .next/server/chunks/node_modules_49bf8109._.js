...
class TwirpRpc {
    ...
    async request(service, method, data, headers) {
        ...
        const camelcaseKeys = await __turbopack_context__.r("[project]/node_modules/camelcase-keys/index.js [app-route] (ecmascript, async loader)")(__turbopack_context__.i).then((mod)=>mod.default);
...
class SipClient extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$livekit$2d$server$2d$sdk$2f$dist$2f$ServiceBase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ServiceBase"] {
   ...
   */ async listSipTrunk() {
    ...
    async listSipInboundTrunk() {
        const req = {};
        const data = await this.rpc.request(svc, "ListSIPInboundTrunk", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$livekit$2d$server$2d$sdk$2f$node_modules$2f40$livekit$2f$protocol$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListSIPInboundTrunkRequest"](req).toJson(), await this.authHeader({}, {
            admin: true
        }));
    ...
    async listSipOutboundTrunk() {
        const req = {};
        const data = await this.rpc.request(svc, "ListSIPOutboundTrunk", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$livekit$2d$server$2d$sdk$2f$node_modules$2f40$livekit$2f$protocol$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListSIPOutboundTrunkRequest"](req).toJson(), await this.authHeader({}, {
            admin: true
        }));
   ...
   */ async createSipDispatchRule(rule, opts) {
    ...
    async listSipDispatchRule() {
        const req = {};
        const data = await this.rpc.request(svc, "ListSIPDispatchRule", new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$livekit$2d$server$2d$sdk$2f$node_modules$2f40$livekit$2f$protocol$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListSIPDispatchRuleRequest"](req).toJson(), await this.authHeader({}, {
            admin: true
        }));
...
//# sourceMappingURL=node_modules_49bf8109._.js.map